...
#include "BasisCore/Public/Projectile.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	BASISCORE_API UClass* Z_Construct_UClass_AProjectile_NoRegister();
	BASISCORE_API UClass* Z_Construct_UClass_AProjectile();
...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AProjectile_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AProjectile_OnHit, "OnHit" }, // 2668283143
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AProjectile_Statics::NewProp_CollisionComp = { "CollisionComp", nullptr, (EPropertyFlags)0x00400000000b0009, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AProjectile, CollisionComp), Z_Construct_UClass_USphereComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_AProjectile_Statics::NewProp_CollisionComp_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AProjectile_Statics::NewProp_CollisionComp_MetaData)) };
	...
	IMPLEMENT_CLASS(AProjectile, 2294480252);
	template<> BASISCORE_API UClass* StaticClass<AProjectile>()
	{
		return AProjectile::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AProjectile(Z_Construct_UClass_AProjectile, &AProjectile::StaticClass, TEXT("/Script/BasisCore"), TEXT("AProjectile"), false, nullptr, nullptr, nullptr);
